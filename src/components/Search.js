            ...
            <div className="search">
                <form className="search-form" onSubmit={props.submitClick}>
                    <div className="search-radio-buttons">
                        ...
                        <label name="searchMethod"><input type="radio" id="postal" name="searchMethod" value="by_postal" checked={props.searchMethod === "postal"} onChange={props.radioClick}/>ZIP/Postal code</label>
